...
def compute_z(x,w,b):
    ...
    ''' TEST: Now you can test the correctness of your code above by typing `nosetests -v test2.py:test_compute_z' in the terminal.  '''
...
def compute_a(z):
    ...
    ''' TEST: Now you can test the correctness of your code above by typing `nosetests -v test2.py:test_compute_a' in the terminal.  '''
...
def compute_L(a,y):
    ...
    ''' TEST: Now you can test the correctness of your code above by typing `nosetests -v test2.py:test_compute_L' in the terminal.  '''
...
def forward(x,y,w,b):
    ...
    ''' TEST: Now you can test the correctness of your code above by typing `nosetests -v test2.py:test_forward' in the terminal.  '''
...
def compute_dL_da(a, y):
    ...
    ''' TEST: Now you can test the correctness of your code above by typing `nosetests -v test2.py:test_compute_dL_da' in the terminal.  '''
...
def compute_da_dz(a):
    ...
    ''' TEST: Now you can test the correctness of your code above by typing `nosetests -v test2.py:test_compute_da_dz' in the terminal.  '''
...
def compute_dz_dw(x):
    ...
    ''' TEST: Now you can test the correctness of your code above by typing `nosetests -v test2.py:test_compute_dz_dw' in the terminal.  '''
...
def compute_dz_db():
    ...
    ''' TEST: Now you can test the correctness of your code above by typing `nosetests -v test2.py:test_compute_dz_db' in the terminal.  '''
...
def backward(x,y,a):
    ...
    ''' TEST: Now you can test the correctness of your code above by typing `nosetests -v test2.py:test_backward' in the terminal.  '''
...
def compute_dL_dw(dL_da, da_dz, dz_dw):
    ...
    dL_dw = np.array([dL_da*da_dz*i for i in dz_dw])

    #########################################
    return dL_dw


    ''' TEST: Now you can test the correctness of your code above by typing `nosetests -v test2.py:test_compute_dL_dw' in the terminal.  '''
...
def compute_dL_db(dL_da, da_dz, dz_db):
    ...
    ''' TEST: Now you can test the correctness of your code above by typing `nosetests -v test2.py:test_compute_dL_db' in the terminal.  '''
...
def update_w(w, dL_dw, alpha=0.001):
    ...
    ''' TEST: Now you can test the correctness of your code above by typing `nosetests -v test2.py:test_update_w' in the terminal.  '''
...
We repeat n_epoch passes over all the training instances.
    ...
    ''' TEST: Now you can test the correctness of your code above by typing `nosetests -v test2.py:test_train' in the terminal.  '''
...
def predict(Xtest, w, b):
    ...
    ''' TEST: Now you can test the correctness of your code above by typing `nosetests -v test2.py:test_predict' in the terminal.  '''
...
''' TEST Problem 2: 
        ...
        If your code passed all the tests, you will see the following message in the terminal:
            ...
            (2 points) dL_da ... ok
            (2 point) da_dz ... ok
            (1 point) compute_dz_dw ... ok
            (1 point) compute_dz_db ... ok
            (1 point) backward ... ok
            (2 point) dL_dw ... ok
            (2 point) dL_db ... ok
            (1 point) update_w ... ok
            ...
            (4 point) train ... ok
            (2 points) predict ... ok
            (4 point) test logistic regression ... ok
